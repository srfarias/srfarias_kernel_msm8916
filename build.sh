...
export ARCH=arm
export SUBARCH=arm
export CROSS_COMPILE=/home/eriko/arm-eabi-5.3/bin/arm-eabi-
export KBUILD_BUILD_USER="eriko"
...
/home/eriko/srfarias_kernel_msm8916/tools/dtbToolCM -2 -o /home/eriko/srfarias_kernel_msm8916/arch/arm/boot/dt.img -s 2048 -p /home/eriko/srfarias_kernel_msm8916/scripts/dtc/ /home/eriko/srfarias_kernel_msm8916/arch/arm/boot/dts/
...
rm -f /home/eriko/surnia_srfarias_kernel_rx.zip
cd flash_zip
zip -r ../arch/arm/boot/srfarias_kernel.zip ./
mv /home/eriko/srfarias_kernel_msm8916/arch/arm/boot/srfarias_kernel.zip /home/eriko/surnia_srfarias_kernel_rx.zip
BUILD_END=$(date +"%s")
